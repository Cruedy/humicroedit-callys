...
# From this paper https://aclanthology.org/2020.semeval-1.108.pdf
...
def baseline_task_1(train_loc, dev_loc, test_loc):
    ...
    valid_df = pd.read_csv(dev_loc)
    test_df = pd.read_csv(test_loc) #this eventually should be a diff file
...
if __name__ == '__main__':
    ...
    baseline_task_1(sys.argv[1], sys.argv[2], sys.argv[3])
